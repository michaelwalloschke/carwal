defmodule CarWal.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias CarWal.Accounts.UserToken
  ...
  # CarWal sessions effectively never expire (FR10: family members are never
  # re-prompted). ~10 years. MUST stay >= @max_cookie_age_in_days in UserAuth —
  # the cookie carries the token but this DB-side check is the binding limit.
  @session_validity_in_days 3650
